                    ...
                    <div class="mb-3">
                        ...
                        <div class="px-5 py-1 mb-4" >
                            ...
                            <div class="btn-group flex gap-3 justify-end" style="display: none;">
                                ...
                                <button id="btn-save" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save</button>
                            </div>
                        </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    posts.forEach((post, index) => {
                        const isLongContent = post.body.length > 100; // Thay đổi chiều dài tối đa theo ý muốn
                        const postHtml = `
